...
class NCUPortal extends AbstractService
{
    ...
    const SCOPE_NOTIFICATION = 'notification';
    const SCOPE_CALENDER = 'calendar';
    const SCOPE_BULLETIN = 'bulletin';
    const SCOPE_MODAL_DIALOG = 'modal-dialog';
    ...
    public function __construct(
        ...
        if (null === $baseApiUri) {
            $this->baseApiUri = new Uri('https://portal3g.ncu.edu.tw/');
        }
    }
    ...
    {
        return new Uri('https://portal3g.ncu.edu.tw/oauth2/authorization');
    }
    ...
    {
        return new Uri('https://portal3g.ncu.edu.tw/oauth2/token');
    }
